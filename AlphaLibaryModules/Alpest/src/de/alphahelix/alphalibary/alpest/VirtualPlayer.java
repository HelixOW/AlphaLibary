...
public class VirtualPlayer implements Player {
    ...
    public VirtualPlayer(JavaPlugin plugin,UUID id, Location fakeLocation) {
        this(plugin, Util.generateRandomString(15), id, fakeLocation);
    }

    public VirtualPlayer(JavaPlugin plugin,Location fakeLocation) {
        this(plugin, Util.generateRandomString(15), UUID.randomUUID(), fakeLocation);
    }
    ...
    private Map<Material, Integer> cooldown = new HashMap<>();
