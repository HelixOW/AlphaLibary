...
public class SimpleTitle {
	...
	public static void sendTitle(Player p, String title, String sub, int fadeIn, int stay, int fadeOut) {
		Object pTitle = PACKET_PLAY_OUT_TITLE.newInstance(true, TitleAction.TITLE.getNmsEnumObject(), ReflectionUtil.toIChatBaseComponentArray(title));
		Object pSubTitle = PACKET_PLAY_OUT_TITLE.newInstance(true, TitleAction.SUBTITLE.getNmsEnumObject(), ReflectionUtil.toIChatBaseComponentArray(sub));
