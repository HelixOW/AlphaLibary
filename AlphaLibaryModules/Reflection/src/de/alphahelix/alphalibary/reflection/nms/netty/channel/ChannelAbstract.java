...
public abstract class ChannelAbstract {
	...
	static final AbstractReflectionUtil.SaveField
	...
	private static final AbstractReflectionUtil.SaveField
	...
	private static final AbstractReflectionUtil.SaveMethod
	...
	public void addServerChannel() {
		try {
			...
			AbstractReflectionUtil.SaveField superListField = new AbstractReflectionUtil.SaveField(currentList.getClass().getSuperclass().getDeclaredField("list"));
