...
import io.github.alphahelixdev.alphalibary.utils.SkinChangeUtil;
...
public class SkullItemBuilder {
    ...
    public enum Skulls implements Serializable {
        ...
        public ItemStack getSkull() {
            return SkullItemBuilder.getPlayerSkull(this.getId());
        }
    ...
    public static class LetterSkulls {
        ...
        public static ItemStack getSkull(LetterSkull skull) {
            ItemStack item = SkullItemBuilder.getCustomSkull(skull.url());
        ...
        public enum Wood implements LetterSkull {
            A {
                @Override
